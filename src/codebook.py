...
class CodeBook:
	'''CodeBook includes all necessary information and
	functions for turning the raw data into mineable form.
	'''
	...
	def __init__(self):
		...
		# Index 16
		# min < val <= max
		self._width = {'0 - 1700 mm': {'max': 1700}, '1700 - 1800 mm': {'min': 1700, 'max': 1800}, '1800 - 1900 mm': {'min': 1800, 'max': 1900},
					'1900 - 2000 mm': {'min': 1900, 'max': 2000}, 'Wider than 2000 mm': {'min': 2000}}
	...
	def __handle_dict(self, value, codes):
		'''Changes raw data values into mineable classes

		value -- raw value in data matrix
		codes -- class codes for attributes
		'''
